        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              coding and quality assurance capabilities.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              {
                name: "Coding Agent",
                description: "Intelligently generates high-quality code based on design specifications and best practices.",
                capabilities: [
              ...
              },
              {
                ...
                description: "Automatically creates and executes comprehensive unit tests for code quality assurance.",
                capabilities: [
              ...
              },
              {
                ...
                description: "Scans code for security vulnerabilities, bugs, and quality issues using advanced analysis.",
                capabilities: [
              ...
              },
              {
                ...
                description: "Conducts automated code reviews to ensure quality, maintainability, and adherence to standards.",
                capabilities: [
              ...
              <motion.div
                ...
                className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-orange-500"
              >
